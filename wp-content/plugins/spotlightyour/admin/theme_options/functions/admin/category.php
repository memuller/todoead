 ...
 * @return string
 */
function DDBWP_option_tree_category( $value, $settings, $int ) 
{ 
	if($value->item_id)
	{
    ...
    <div class="section">
      <div class="element">
        <div class="select_wrapper">
          ...
          {
            echo '<option value="0">No Cities Available</option>';
          }
          ?>
          </select>
        </div>
 ...
 * @return string
 */
function DDBWP_option_tree_categories( $value, $settings, $int ) 
{ 
	if($value->item_id)
	{
		$option_val = get_option($value->item_id);	
