<?php
// ============== Twitter widget ======================================
if(!class_exists('DDBWP_twitter'))
{
	class DDBWP_twitter extends WP_Widget {
		function DDBWP_twitter() {
		//Constructor
			$widget_ops = array('classname' => 'twitter', 'description' => apply_filters('DDBWP_twitter_widget_desc_filter',__('Enter your Twitter login ID and it will show latest tweet at your site. One time use per page.','ddb_wp')) );
			$this->WP_Widget('widget_twidget', apply_filters('DDBWP_twitter_widget_title_filter',__('T &rarr; Twitter Feed','ddb_wp')), $widget_ops);
		}
		...
		//widgetform in backend
			$instance = wp_parse_args( (array) $instance, array('account'=>'', 'title'=>__('Live Tweet','ddb_wp'), 'show'=>'3' ) );
	...
	?>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('account'); ?>"><?php  _e('Twitter Account ID','ddb_wp')?>:
        ...
        <p>
          <label for="<?php echo $this->get_field_id('show'); ?>"><?php  _e('Show Twitter Posts','ddb_wp')?>:
        ...
        <p>
          <label for="<?php echo $this->get_field_id('follow_text'); ?>"><?php  _e('Twitter Button Text','ddb_wp')?>:
