...
class contact_widget extends WP_Widget {
	...
	//Constructor
		$widget_ops = array('classname' => 'Contact Us', 'description' => apply_filters('DDBWP_contact_widget_desc_filter','Contact Us Widget') );		
		$this->WP_Widget('widget_contact', apply_filters('DDBWP_contact_widget_title_filter','T &rarr; Contact Us'), $widget_ops);
	}
...
if($_POST && $_POST['contact_widget'])
{
	if($_POST['your-email'])
	{
		...
		// Mail it
		DDBWP_sendEmail($_POST['your-email'],$_POST['your-name'],$toEmail,$toEmailName,$subject,$message);
...
{
?>
	<p class="success_msg"><?php echo apply_filters('DDBWP_contact_widget_successmsg_filter',__('Thank you, your information is sent successfully.','ddb_wp'));?></p>
<?php
}elseif($_REQUEST['err'] == 'empty')
{
?>
	<p class="error_msg"><?php echo apply_filters('DDBWP_contact_widget_errormsg_filter',__('Please fill out all the fields before submitting.','ddb_wp'));?></p>
<?php
}
?>
    ...
    <div class="form_row "> <label> <?php _e('Name','ddb_wp');?> <span class="indicates">*</span></label>
    ...
    <div class="form_row "><label><?php _e('Email','ddb_wp');?>  <span class="indicates">*</span></label>
       ...
       <div class="form_row "><label><?php _e('Subject','ddb_wp');?> <span class="indicates">*</span></label>
    ...
    <div class="form_row"><label><?php _e('Message','ddb_wp');?> <span class="indicates">*</span></label>
    ...
    <span id="widget_your_messageInfo"  class="error"></span>
        ...
        <input type="submit" value="<?php _e('Send','ddb_wp');?>" class="b_submit" />  
  </form> 
<script type="text/javascript" src="<?php echo DDB_WIDGETS_FOLDER_URL; ?>contact/contact_validation1.js"></script>
</div>
