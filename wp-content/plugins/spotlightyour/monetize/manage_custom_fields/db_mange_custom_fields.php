...
add_action('DDBWP_admin_menu', 'post_custom_fields_add_admin_menu');
function post_custom_fields_add_admin_menu()
{
	add_submenu_page('ddb_wp_wp_admin_menu', __("Manage Custom Fields",'ddb_wp'), __("Post Custom Fields",'ddb_wp'), DDBWP_ACCESS_USER, 'custom', 'manage_custom');
}
...
function manage_custom()
{
	...
	{
		apply_filters( 'ddb_wp_custom_fields', include_once(DDB_MODULES_FOLDER_PATH . 'manage_custom_fields/admin_manage_custom_fields_edit.php') )	;
	}else
	{
		apply_filters( 'ddb_wp_custom_fields', include_once(DDB_MODULES_FOLDER_PATH . 'manage_custom_fields/admin_manage_custom_fields_list.php') )	;
	}
}
/////////admin menu settings end////////////////
include_once (DDB_MODULES_FOLDER_PATH . 'manage_custom_fields/functions_custom_field.php');
include_once(DDB_MODULES_FOLDER_PATH.'manage_custom_fields/manage_post_custom_fields.php');
?>