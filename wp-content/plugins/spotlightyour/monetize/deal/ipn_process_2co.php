...
if ($result == '1')
{
	...
	if($transifo['deal_type']=='4' || $transifo['deal_type']=='5')
	{
		...
		if($coupon_address!="")
		{
			...
			<p>Trans ID: %s\r</p> <p>2co Trans ID: %s\r</p> <p>Response Code: %s\r</p>	<p>Response Text: %s\r</p>	<p>Date: %s\r</p>",'ddb_wp'),$postid,$item_name,$coup,$coupon_address,$last_trans_id,$pnref,$result,$respmsg,date("Y-m-d H:i:s"));
		}
		else
		{
			$transaction_details = sprintf(__("
			...
			<p>Deal Title: %s \r</p>
			<p>Deal Coupon: %s \r	</p>
			<p>Trans ID: %s\r</p> <p>2co Trans ID: %s\r</p> <p>Response Code: %s\r</p>	<p>Response Text: %s\r</p>	<p>Date: %s\r</p>",'ddb_wp'),$postid,$item_name,$coup,$last_trans_id,$pnref,$result,$respmsg,date("Y-m-d H:i:s"));
		}
	}
	else
	{
		...
		<p>Trans ID: %s\r</p> <p>2co Trans ID: %s\r</p> <p>Response Code: %s\r</p>	<p>Response Text: %s\r</p>	<p>Date: %s\r</p>",'ddb_wp'),$postid,$item_name,$coup,$post_title_link,$last_trans_id,$pnref,$result,$respmsg,date("Y-m-d H:i:s"));
	}
