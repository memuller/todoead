...
<?php echo stripslashes(get_option('ddbwpthemes_logoin_page_content'));?>
</div>
...
<input type="hidden" name="redirect_to" value="<?php echo get_settings('home').'/?dwtype='.$_GET['dwtype'].'&did='.$_GET['did']; ?>" />
