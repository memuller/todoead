...
function show_image_uploader () {
	...
	?>
	upload_url: "<?php echo DDB_PUGIN_URL; ?>/library/includes/deal/upload.php<?php  echo $upld_sub;?>",
	...
	// Button Settings
	button_image_url : "<?php echo DDB_PUGIN_URL; ?>/library/js/swfupload/SmallSpyGlassWithTransperancy_17x18.png",
...
/* ]]> */
	...
	if($thumb_img_arr)
	{
        ...
        <div class="imageBox" id="div_<?php echo $thumb_img_arr[$i]['id'];?>">
            ...
            <div class="imageBox_label"><span><a href="javascript:void(0);" id="a_photo_<?php echo $thumb_img_arr[$i]['id'];?>" onClick="javascript:removePhoto(<?php echo $thumb_img_arr[$i]['id'];?>,'');"><img src="<?php echo DDB_PUGIN_URL; ?>/images/x.png" class="img_delete" alt="" ></a></span></div>
		</div>
		<?php
		}
	}
