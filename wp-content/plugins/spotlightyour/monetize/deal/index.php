...
<script type="text/javascript" src="<?php echo DDB_PUGIN_URL;?>/library/js/jquery-ui-1.8.14.custom.min.js"></script>
...
{
	require_once (DDB_PUGIN_PATH . '/monetize/send_to_friend/email_friend_frm.php');exit;
}
  ...
  <div class=" box_bottom">
    ...
    <div class="content_left"> <a href="<?php the_permalink(); ?>">
      <?php	if(get_post_meta($post->ID,'file_name',true) != "") { 
				...
				?>
      <img src="<?php echo DDBWP_thumbimage_filter($destination_url.get_post_meta($post->ID,'file_name',true),'&amp;w=330&amp;h=250&amp;zc=1&amp;q=80');?>" alt="" />
      <?php } else { 
							if (is_super_admin($post->post_author)){
								echo display_deal_image($post->ID,'medium');
							} else {?>
      <img src="<?php echo DDBWP_thumbimage_filter(DDB_PUGIN_URL."/images/no-image.png",'&amp;w=330&amp;h=250&amp;zc=1&amp;q=80');?>" alt="" />
      <?php 	} ?>
      <?php 	} ?>
      </a> </div>
    ...
    <div class="share_div index_share_spacer">
      <div class="twiDDB_like">
        <?php DDBWP_show_twitter_button();	?>
      </div>
      <div class="googleplus">
        <script type="text/javascript" src="https://apis.google.com/js/plusone.js"></script>
        <g:plusone size="medium"></g:plusone>
      </div>
      <?php DDBWP_show_facebook_button();?>
...
<?php include_once (DDB_PUGIN_PATH . '/monetize/send_to_friend/popup_frms.php');?>
<?php get_footer(); ?>
