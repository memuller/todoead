...
<script type="text/javascript" src="<?php echo DDB_PUGIN_URL;?>/monetize/deal/post_deal_validation.js"></script>
<?php 
function get_date_format() {
	global $wpdb;
	$tbl_option = $wpdb->prefix."options";
	$getDate = $wpdb->get_row("select * from  $tbl_option where option_name like 'ddbwpthemes_date_format' ");
	if($getDate == "" ) {
		$getDate = "yyyy - mm - dd";
	} else	{
...
<?php
						 if(get_option('ddbwpthemes_add_customlink_deal_allow')!='No' || get_option('ddbwpthemes_add_fixed_deal_allow')!='No' || get_option('ddbwpthemes_add_customgen_deal_allow')!='No' || get_option('ddbwpthemes_add_physicalbarcode_deal_allow')!='No' || get_option('ddbwpthemes_add_physicalproduct_deal_allow')!='No' ){?>
						 var deal_val = true;
						 <?php } ?>
</script>
       	...
       	<div class="entry">
            <div <?php post_class('single clear'); ?>>
				...
				<p><?php if($_REQUEST['editdeal']!="") {
					_e(EDIT_FORM_MSG,'ddb_wp');
				}	else{
					_e(POST_FORM_MSG,'ddb_wp');
				} ?></p>
					...
					<?php	if($current_user->data->ID == "")	{	?>
						...
						<?php 	} ?>
								...
								<?php include_once('login_frm.php');?></div>
									...
									<form id="postdeal_frm" name="postdeal_frm" action="<?php echo site_url('/?dwtype=previewdeal');?>" method="post" enctype="multipart/form-data">
						...
						<?php 		if($current_user->data->ID == "") { ?>
										...
										<div class="form_row clearfix">
											...
											<input type="text" class="textfield" id="owner_name" name="owner_name" value="<?php _e($select_name_email->display_name,'ddb_wp');  ?>" <?php if(mysql_affected_rows() >0){ ?> readonly <?php } ?> tabindex="3"><span id="user_fname_Info" class="error"></span>
										</div>							   
										<div class="form_row clearfix">
											<label><?php echo POST_DEAL_EMAIL_TEXT;?> <span class="indicates">*</span></label>
											<input type="text" class="textfield" id="owner_email" name="owner_email" value="<?php _e($select_name_email->user_email,'ddb_wp');?>" <?php if(mysql_affected_rows() >0){ ?> readonly <?php } ?> tabindex="4"><span id="user_emailInfo"  class="error"></span>
										</div>
							<?php 	} else if (isset($_REQUEST['editdeal']) || $_REQUEST['editdeal'] != ""){ ?>
										<input type="hidden" class="textfield" id="owner_name" name="owner_name" value="<?php _e($select_name_email->display_name,'ddb_wp');  ?>" >
										<input type="hidden" class="textfield" id="owner_email" name="owner_email" value="<?php	 echo _e($select_name_email->user_email,'ddb_wp');?>" >
						...
						<?php 		} ?>
								...
								<div class="form_row clearfix">
									...
									<input type="text" class="textfield" id="post_title" name="post_title" value="<?php if(isset($dealsession) || $dealsession != "") { _e($_SESSION['post_title'],'ddb_wp'); }elseif($_REQUEST['editdeal'] != ""){ echo $edit_deal->post_title;  }?>" tabindex="5">
								...
								<div class="form_row clearfix" >
									...
									<textarea name="post_excerpt" id="post_excerpt" class=" mce" cols="60" rows="10" tabindex="6"><?php if(isset($dealsession) || $dealsession != "") {  _e($_SESSION['post_content'],'ddb_wp');   }else{  echo htmlspecialchars($edit_deal->post_content); } ?></textarea><small><?php echo BUY_DEAL_DESC_TEXT; ?></small><span id="deal_descInfo" class="error"></span>
								</div>								
								<div class="form_row clearfix" >
									<label><?php echo DEAL_DESC_TEXT;?> <span class="indicates">*</span></label>
									<textarea name="post_content" id="post_content" class=" mce" cols="60" rows="10" tabindex="6"><?php if(isset($dealsession) || $dealsession != "") {  _e($_SESSION['post_content'],'ddb_wp');   }else{  echo htmlspecialchars($edit_deal->post_content); } ?></textarea><small><?php echo BUY_DEAL_DESC_TEXT; ?></small><span id="deal_descInfo2" class="error"></span>
								</div>
								<div class="form_row clearfix">
									<label><?php echo DEAL_NO_OF_ITEM;?> <span class="indicates">*</span></label>
									<input type="text" onkeyup="return no_of_coupon1();" class="textfield" id="no_of_coupon" name="no_of_coupon" value="<?php if(isset($dealsession) || $dealsession != "") { _e($_SESSION['no_of_coupon'],'ddb_wp');  }else{ echo get_post_meta($edit_deal->ID,'no_of_coupon',true); } ?>" tabindex="7">
								...
								<div class="form_row clearfix">
									...
									<input type="text" class="textfield" id="current_price" name="current_price" value="<?php if(isset($dealsession) || $dealsession != "") { _e($_SESSION['current_price'],'ddb_wp');   }else{ echo get_post_meta($edit_deal->ID,'current_price',true); }?>" tabindex="8">
								...
								<div class="form_row clearfix">
									...
									<input type="text" class="textfield" id="our_price" name="our_price" value="<?php if(isset($dealsession) || $dealsession != "") { _e($_SESSION['our_price'],'ddb_wp'); }else{ echo get_post_meta($edit_deal->ID,'our_price',true); } ?>"  tabindex="9"><span id="our_priceInfo" class="error"></span>
									<small><?php echo DEAL_DISCOUNT_PRICE_DESC.FREE_DEAL_DESC;?></small>
								</div>
								 <?php		 if(get_option('ddbwpthemes_add_customlink_deal_allow')!='No' && get_option('ddbwpthemes_add_fixed_deal_allow')!='No' && get_option('ddbwpthemes_add_customgen_deal_allow')!='No' && get_option('ddbwpthemes_add_physicalbarcode_deal_allow')!='No' && get_option('ddbwpthemes_add_physicalproduct_deal_allow')!='No' ) 
					{ ?>
						  ...
						  <?php }?> 
						        ...
						        <div class="form_row clearfix">
									...
									<select class="textfield" onchange="coupon_change_type(this.value);" name="coupon_type" id="coupon_type" tabindex="10">
										<option id="coupon_type_0" value="0" <?php if($_SESSION['coupon_type'] == 0 || get_post_meta($_REQUEST['editdeal'],'deal_type',true) == 0) {?>selected <?php } ?>><?php echo "Select Deal Type";?></option>
										 <?php if(get_option('ddbwpthemes_add_customlink_deal_allow')!='No'){?>
									...
									<?php if(get_option('ddbwpthemes_add_customgen_deal_allow')!='No'){?>
									...
									<?php if(get_option('ddbwpthemes_add_physicalbarcode_deal_allow')!='No'){?>
									...
									</select> <a href="#" class="tooltip"><img src="<?php echo DDB_PUGIN_URL;?>/images/info.png" alt="Information"><div><?php echo DEAL_TYPE_DESC;?></div></a><span id="coupon_typeInfo" class="error"></span>
								<div id="descdiv" ></div>
                                ...
                                <div id="multicode" <?php if($_SESSION['coupon_entry'] == "coupon_entry_1" || get_post_meta($_REQUEST['editdeal'],'coupon_entry',true) == "coupon_entry_1" ) { ?>style="display:block;"<?php }else{ ?>style="display:none;"<?php } ?>>
									...
									<div class="descdiv"><span id="count_no_of_coupon" style="font-weight:bold;" ><?php _e('0 ','ddb_wp');?></span><?php echo " out of ";?><span style="font-weight:bold;" id="coupons"></span><?php _e(' entered','ddb_wp');?></div>
									</div>	
									<div class="form_row clearfix">
                                ...
                                <div id="coupon_expired" style="display:none;">
									<div class="form_row clearfix">
										...
										<input type="text" name="coupon_expired_date" id="coupon_expired_date" class="textfield" tabindex="16" value="<?php if(isset($dealsession) || $dealsession != "") { echo $_SESSION['coupon_expired_date']; }else{ echo get_post_meta($edit_deal->ID,'coupon_expired_date',true); } ?>"/>&nbsp;<img src="<?php echo DDB_PUGIN_URL;?>/images/cal.gif" alt="Calendar" onclick="displayCalendar(document.postdeal_frm.coupon_expired_date,'<?php echo DDBWP_get_date_format(); ?>',this)" class="calendar_img">&nbsp;&nbsp;
									</div>
								</div>
                                ...
                                <input type="text" class="textfield" id="shipping_cost" name="shipping_cost" value="<?php if(isset($dealsession) || $dealsession != " ") { _e($_SESSION['shipping_cost'],'ddb_wp');  }else{ echo get_post_meta($edit_deal->ID,'shipping_cost',true); } ?>" tabindex="18">
                             ...
                             <div class="form_row clearfix">
                                ...
                                <input type="text" class="textfield" id="shhiping_address" name="shhiping_address" value="<?php if(isset($dealsession) || $dealsession != " ") { _e($_SESSION['shhiping_address'],'ddb_wp');  }else{ echo get_post_meta($edit_deal->ID,'shhiping_address',true); } ?>" tabindex="19">
							...
							<?php if(get_option(ptttheme_google_map_opt) == 'Enable' && get_option('pttheme_google_map_api') != '') {  ?>
							 ...
							 <div class="form_row clearfix">
								...
								<input type="text" name="geo_latitude" id="geo_latitude" class="textfield" value="<?php if(isset($dealsession) || $dealsession != " ") { _e($_SESSION['geo_latitude'],'ddb_wp');  }else{ echo get_post_meta($edit_deal->ID,'geo_latitude',true); } ?>" size="25" tabindex="20" />
								<span class="message_note"><?php echo GET_LATITUDE_MSG;?></span>
							 </div>
							 <div class="form_row clearfix">
								<label><?php echo EVENT_ADDRESS_LNG;?> </label>
								<input type="text" name="geo_longitude" id="geo_longitude" class="textfield" value="<?php if(isset($dealsession) || $dealsession != " ") { _e($_SESSION['geo_longitude'],'ddb_wp');  }else{ echo get_post_meta($edit_deal->ID,'geo_longitude',true); } ?>" size="25" tabindex="21" />
							 ...
							 <?php } ?>
								...
								<div class="category_list clearfix">
									...
									foreach($pageposts as $pageposts_obj) {	?>
											...
											<label>
												<input name="deal_category[]"  id="<?php _e($pageposts_obj->name,'ddb_wp'); ?>" type="checkbox" value="<?php _e($pageposts_obj->term_taxonomy_id,'ddb_wp'); ?>" tabindex="22"	/>	
												<?php _e($pageposts_obj->name,'ddb_wp'); ?>
											</label>
							...
							<div class="form_row clearfix">
								...
								<input type="text" name="coupon_start_date"  id="coupon_start_date" class="textfield calendar_text" value="<?php echo $coupon_start_date; ?>"/>  <img src="<?php echo DDB_PUGIN_URL;?>/images/cal.gif" alt="Calendar" onclick="displayCalendar(document.postdeal_frm.coupon_start_date,'<?php echo DDBWP_get_date_format(); ?>',this)" class="calendar_img" tabindex="23"> 
						...
						<?php	for($i=0;$i<=59;$i++){
							...
							<span class="disable_checkbox" ><label><input name="enddate" id="enddate" type="checkbox" value="0" onchange="disable_endtime()" /><?php echo DISABLE_END_TIME; ?></label></span>
						 	<div class="form_row clearfix" id="end_deal_time">							
								...
								<input type="text" name="coupon_end_date"  id="coupon_end_date" class="textfield calendar_text" value="<?php echo $coupon_end_date; ?>"/> <img style="margin:0px" src="<?php echo DDB_PUGIN_URL;?>/images/cal.gif" alt="Calendar" onclick="displayCalendar(document.postdeal_frm.coupon_end_date,'<?php echo DDBWP_get_date_format(); ?>',this)" class="calendar_img"> 
								<label class="time_label"><?php echo DEAL_HH;?></label>
                        ...
                        <div class="form_row clearfix">
							...
							<?php 
								...
								<img src="<?php if($_SESSION['deal_image'] !="") { echo DDBWP_thumbimage_filter($_SESSION['deal_image'],'&amp;w=168&amp;h=180&amp;zc=1&amp;q=80'); }else{ echo DDBWP_thumbimage_filter($destination_path.get_post_meta($edit_deal->ID,'file_name',true),'&amp;w=168&amp;h=180&amp;zc=1&amp;q=80'); } ?>" alt="<?php $_SESSION['filename']; ?>" /> <?php } ?>
							...
							<img src="<?php echo DDBWP_thumbimage_filter($destination_path.get_post_meta($edit_deal->ID,'file_name',true),'&amp;w=168&amp;h=180&amp;zc=1&amp;q=80'); ?>" alt="<?php $edit_deal->post_title; ?>" />
							<?php }
							}else{   ?>
								<img src="<?php echo DDBWP_thumbimage_filter(DDB_PUGIN_URL."/images/no-image2.png",'&amp;w=168&amp;h=180&amp;zc=1&amp;q=80');?>" alt="No Image Available" />
								<?php } ?>
							</a>
							...
							<div class='file_browse_wrapper'><input type="file" name="deal_image" id="deal_image" class="file_browse"/><?php echo $edit_deal->image_name; ?></div>
								...
								<div class="form_row clearfix">
									...
									<input type="text" class="textfield" id="coupon_website" name="coupon_website" value="<?php if(isset($dealsession) || $dealsession != "") {   _e($_SESSION['coupon_website'],'ddb_wp'); }else if($_REQUEST['editdeal'] != ""){ echo get_post_meta($edit_deal->ID,'coupon_website',true);  } else { echo "http://";} ?>">
								...
								<div class="form_row clearfix">
									...
									<input type="text" class="textfield" id="thankyou_page_url" name="thankyou_page_url" value="<?php if(isset($dealsession) || $dealsession != "") { _e($_SESSION['thankyou_page_url'],'ddb_wp'); }else if($_REQUEST['editdeal'] != ""){ echo get_post_meta($edit_deal->ID,'thankyou_page_url',true); } else { echo "http://";} ?>">
						...
						<h4><?php echo PURCHASE_TEXT; ?></h4>
                        	...
                        	<div class="form_row clearfix">
								...
								<input type="text" class="textfield" id="min_purchases" name="min_purchases" value="<?php if(isset($dealsession) || $dealsession != " ") { _e($_SESSION['min_purchases'],'ddb_wp');  }elseif(get_post_meta($edit_deal->ID,'min_purchases',true) != ""){ echo get_post_meta($edit_deal->ID,'min_purchases',true);  }else{ echo "1"; }								?>">
                             ...
                             <div class="form_row clearfix">
								...
								<input type="text" class="textfield" id="max_purchases_user" name="max_purchases_user" value="<?php if(isset($dealsession) || $dealsession != " ") {  _e($_SESSION['max_purchases_user'],'ddb_wp'); }else{ echo get_post_meta($edit_deal->ID,'max_purchases_user',true); } ?>">
						...
						<?php
								...
								$custom_post_meta_db_table_name = $table_prefix . "ddb_wp_custom_post_fields";
