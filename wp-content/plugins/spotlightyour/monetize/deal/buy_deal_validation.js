...
$c(document).ready(function(){
	...
	enquiryfrm.submit(function(){
		if(validate_user_fname() & validate_user_email() & validate_billing_name() & validate_user_add() & validate_user_city() & validate_user_state() & validate_user_country() & validate_user_postalcode())
		{
			hideform();
			return true
		}
