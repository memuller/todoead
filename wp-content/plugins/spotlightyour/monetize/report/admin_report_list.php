...
?>
<h3>Seller Report</h3>
<div class="divright"><a href="<?php echo DDB_PUGIN_URL.'/monetize/report/export_report.php';?>" title="Export To CSV" class="i_export">Export To CSV</a></div>
  <form method="post" action="<?php echo site_url('/wp-admin/admin.php?page=report');?>" name="ordersearch_frm">
        <table cellspacing="1" cellpadding="4" border="1" width="100%" style="padding:5px;">
            <tr>
				<td valign="top" style="width:100px;"><strong><?php _e('Seller Name','ddb_wp'); ?> :</strong></td>
...
<table style="100%" cellpadding="5" class="widefat post fixed" >
  <thead>
    <tr>
		...
		<th align="left"><?php _e('Seller','ddb_wp'); ?></th>
		<th align="left" width="50"><?php _e('Deal','ddb_wp'); ?></th>
		<th align="left" width="50"><?php _e('Sale','ddb_wp'); ?></th>
		<th align="left" width="100"><?php _e('Customer','ddb_wp'); ?></th>
...
?>
    <tr>
      ...
      <td><?php echo deal_salecount_post($priceinfoObj->ID);?></td>
      <td><a href="javascript:void(0);showdetail('<?php echo $priceinfoObj->ID;?>');"><?php _e('Details','ddb_wp');?></a> | <a href="<?php echo DDB_PUGIN_URL.'/monetize/report/export_report.php?id='.$priceinfoObj->ID;?>"><?php _e('Export','ddb_wp');?></a></td>
    </tr>
