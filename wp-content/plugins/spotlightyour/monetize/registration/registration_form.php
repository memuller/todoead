...
<!-- /TinyMCE -->
<div id="sign_up">
  <div class="login_content"> <?php echo stripslashes(get_option('ddbwpthemes_reg_page_content'));?> </div>
  <div class="registration_form_box">
    <h4>
      <?php  include(DDB_PUGIN_URL."/monetize/registration/registration_language.php");
...
?>
    <form name="userform" id="userform" action="<?php echo site_url().'/?dwtype=login&amp;action=register'; ?>" method="post" enctype="multipart/form-data" >  
      <input type="hidden" name="reg_redirect_link" value="<?php echo $_SERVER['HTTP_REFERER'];?>" />
      <?php do_action('DDBWP_registration_form_start');?>
		<?php
		...
		do_action('DDBWP_registration_form_end');?>
