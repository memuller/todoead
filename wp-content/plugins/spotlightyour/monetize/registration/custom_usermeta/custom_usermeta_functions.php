<?php
function DDBWP_get_usermeta($types='registration')
{
...
function get_custom_usermeta_single_page($pid, $paten_str,$fields_name='')
{
	...
	if($post_meta_info){
		foreach($post_meta_info as $user_meta_info_obj){
			...
			$image_var = "<img src='".DDBWP_thumbimage_filter(get_usermeta($pid,$user_meta_info_obj->htmlvar_name,true),'&amp;w=100&amp;h=100&amp;zc=1&amp;q=80')."'/>";
