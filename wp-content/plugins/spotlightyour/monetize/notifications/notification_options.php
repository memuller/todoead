...
$notification_email = apply_filters('DDBWP_email_notifications_filter',$notification_email);  //wp-admin email notification content controller filter
...
$notification_msg = apply_filters('DDBWP_msg_notifications_filter',$notification_msg);  //wp-admin message notification content controller filter
?>