...
<p><?php _e('Notification emails are sent to the administrator and sellers at various events like submitting a deal, rejecting a deal request, expiration of deals, etc. You can customize these notification emails and messages here.','ddb_wp');?></p>
<?php if($_REQUEST['msg']=='success'){?>
<div class="updated fade below-h2" id="message" style="background-color: rgb(255, 251, 204);" >
<p><?php _e('updated successfully.','ddb_wp'); ?></p>
</div>
<?php }?>
...
<thead>
<tr>
<th width="120" align="left"><?php _e('Email type','ddb_wp'); ?></th>
<th width="120" align="left"><?php _e('Subject','ddb_wp'); ?></th>
<th width="320" align="left"><?php _e('Message','ddb_wp'); ?></th>
</tr>
</thead>
<?php
foreach($notification_email as $notification)
...
<tr>
  <td>&nbsp;</td>
  <td><input type="submit" name="Submit" value="<?php _e('Save All Changes','ddb_wp')?>" class="button-framework save-options button-framework-imp"> <td>
  </td>
</tr>
...
<thead>
<tr>
  <th width="138" align="left"><strong><?php _e('Title','ddb_wp'); ?></strong></th>
  <th align="left" colspan="2"><strong><?php _e('Description','ddb_wp'); ?></strong></th>
</tr>
</thead>
<?php
$counter = "";
