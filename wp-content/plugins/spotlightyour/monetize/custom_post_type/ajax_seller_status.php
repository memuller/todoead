...
function seller_accept_deal($deal_id)
{
	...
	$deal_details = "<b>Title : </b>".$deal_data->post_title."<br/><br/>"."<b>Duration : </b>".$start_date." to ".$end_date."<br/><br/>"."<b>Your price : </b>".get_post_currency_sym($deal_data->ID).$deal_data->our_price."<br/><br/>"."<b>Current price : </b>".get_post_currency_sym($deal_data->ID).$deal_data->current_price."<br/><br/>"."<b>Total Items :</b>".$deal_data->no_of_coupon."<br/><br/><b>Coupon code :</b>".$deal_data->coupon_code;
