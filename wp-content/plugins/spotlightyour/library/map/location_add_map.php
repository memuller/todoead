...
{
?>
var CITY_MAP_CENTER_LAT = '<?php echo get_option('ddbwpthemes_latitute');?>';
var CITY_MAP_CENTER_LNG = '<?php echo get_option('ddbwpthemes_longitute');?>';
var CITY_MAP_ZOOMING_FACT=<?php echo get_option('ddbwpthemes_scaling_factor');?>;
<?php }?>
