...
require_once(DDB_PUGIN_PATH . '/library/includes/payment/authorizenet/authorizenet.class.php');
...
switch ($a->process()) {
   ...
   case 1:  // Successs
     //payment_success
	$redirectUrl = site_url("/?dwtype=payment_success&pid=".$last_postid);
...
{
	global $last_postid;
	wp_redirect(site_url()."/?dwtype=success&pid=".$last_postid);
	exit;
}
?>