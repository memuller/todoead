<?php
global $payable_amount,$post_title,$last_postid,$post;
...
$currency_code = get_post_meta($_REQUEST['did_deal'],'currency',true);
if(empty($currency_code)){
	$currency = explode('-',get_currency_code());
	$currency_code = $currency[0];
}

?>
<!--<form name="frm_payment_method" action="https://www.paypal.com/cgi-bin/webscr" method="post">-->
<form name="frm_payment_method" action="https://sandbox.paypal.com/cgi-bin/webscr" method="post">
