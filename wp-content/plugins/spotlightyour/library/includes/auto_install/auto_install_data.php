...
//require_once (DDB_PUGIN_PATH . '/delete_data.php');
$dummy_image_path = DDB_PUGIN_URL.'/images/dummy/';
...
$post_meta = array(
				   "DDBWP_seo_page_title" =>'Post with Different Headings',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   "DDBWP_seo_page_title" =>'Testing Different Elements',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   ...
				   "DDBWP_seo_page_title" =>'Collection of all Content Boxes and Dropcaps',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   ...
				   "DDBWP_seo_page_title" =>'The Best Deals on the Internet',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   "DDBWP_seo_page_title" =>'Behind the Deals',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   ...
				   "DDBWP_seo_page_title" =>'Behind the Deals Lunch Hour',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   ...
				   "DDBWP_seo_page_title" =>'Customer Service is our First Priority',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   ...
				   "DDBWP_seo_page_title" =>'Meet a Deal Employee',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   ...
				   "DDBWP_seo_page_title" =>'Live Stream the Webby Awards.',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
				   "DDBWP_seo_page_title" =>'And the Contest Winner is',
				   "DDBWP_seo_page_kw" => '',
"tl_dummy_content"	=> '1',
				   "DDBWP_seo_page_desc" => '',
				);
...
$post_meta = array(
					...
					"coupon_website"	        => 'http://www.ddb_wp.com',
					"coupon_start_date_time"	=> $cstartdate,
					"owner_name"	        	=> 'ddb_wp',
					"owner_email"	        	=> 'testddb_wp@gmail.com',
					"coupon_type"	        	=> '1',
					"coupon_link"	        	=> 'http://ddb_wp.com',
					"status"	        		=> '2',					
					"_edit_last"	        	=> '1',					
					"_edit_lock"	        	=> '1310982937:1',
					"coupon_website"	        => 'http://ddb_wp.com',
					"tl_dummy_content"			=> '1',
					"min_purchases"	        	=> '1',
					"max_purchases_user"		=> '2',
					"file_name"				=>  $destination_url.'dummy/karate.jpg',
					"our_price"	        		=> '20',
					"current_price"	 			=> '100',
					"coupon_entry"				=> 'coupon_entry_1',
					"thankyou_page_url"			=> 'http://ddb_wp.com',
			);
$post_info[] = array(
...
$post_meta = array(
					...
					"min_purchases"	        	=> '1',
					"max_purchases_user"		=> '2',
					"file_name"					=> $destination_url.'dummy/computer.jpg',
					"our_price"	        		=> '60',
					"current_price"	 			=> '150',
					"coupon_entry"				=> 'coupon_entry_1',
					"thankyou_page_url"			=> 'http://ddb_wp.com',
...
$post_meta = array(
					...
					"min_purchases"	        	=> '1',
					"max_purchases_user"		=> '2',
					"file_name"				=> $destination_url.'dummy/food.jpg',
					"our_price"	        		=> '20',
					"current_price"	 			=> '40',
					"coupon_entry"				=> 'coupon_entry_1',
					"thankyou_page_url"			=> 'http://ddb_wp.com',
...
$post_meta = array(
					...
					"tl_dummy_content"			=> '1',
					"min_purchases"	        	=> '1',
					"file_name"				=> $destination_url.'dummy/comedy.jpg',
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '30',
					"current_price"	 			=> '60',
					"coupon_entry"				=> 'coupon_entry_1',
...
$post_meta = array(
					...
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '50',
					"file_name"				=> $destination_url.'dummy/art.jpg',
					"current_price"	 			=> '125',
					"coupon_entry"				=> 'coupon_entry_1',
...
$post_meta = array(
					...
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '25',
					"file_name"				=> $destination_url.'dummy/ok.jpg',
					"current_price"	 			=> '150',
					"coupon_entry"				=> 'coupon_entry_1',
					"coupon_code"				=> 'greatdiscount,getdiscount,friends,coupons',
					"thankyou_page_url"			=> 'http://ddb_wp.com',
...
$post_meta = array(
					...
					"min_purchases"	        	=> '1',
					"max_purchases_user"		=> '2',
					"file_name"					=> $destination_url.'dummy/jalsa.jpg',
					"our_price"	        		=> '30',
					"current_price"	 			=> '70',
					"coupon_entry"				=> 'coupon_entry_1',
					"coupon_code"				=> 'greatdiscount,getdiscount,friends,coupons',
...
$post_meta = array(
					...
					"tl_dummy_content"			=> '1',
					"min_purchases"	        	=> '1',
					"file_name"					=> $destination_url.'dummy/cleaning.jpg',
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '70',
					"current_price"	 			=> '110',
					"coupon_entry"				=> 'coupon_entry_1',
...
$post_meta = array(
					...
					"tl_dummy_content"			=> '1',
					"min_purchases"	        	=> '1',
					"file_name"					=> $destination_url.'dummy/golf.jpg',
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '49',
					"current_price"	 			=> '85',
					"coupon_entry"				=> 'coupon_entry_1',
...
$post_meta = array(
					...
					"_edit_lock"	        	=> '1310982937:1',
					"coupon_website"	        => 'http://ddb_wp.com',
					"file_name"					=> $destination_url.'dummy/shoes.jpg',
					"tl_dummy_content"			=> '1',
					"min_purchases"	        	=> '1',
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '39',
...
$post_meta = array(
					...
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '20',
					"file_name"					=> $destination_url.'dummy/carwash.jpg',
					"current_price"	 			=> '40',
					"coupon_entry"				=> 'coupon_entry_1',
					"coupon_code"				=> 'greatdiscount,getdiscount,friends,coupons',
					"thankyou_page_url"			=> 'http://ddb_wp.com',
...
$post_meta = array(
					...
					"tl_dummy_content"			=> '1',
					"min_purchases"	        	=> '1',
					"file_name"					=> $destination_url.'dummy/spa3.jpg',
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '120',
					"current_price"	 			=> '200',
					"coupon_entry"				=> 'coupon_entry_1',
...
$post_meta = array(
					...
					"min_purchases"	        	=> '1',
					"max_purchases_user"		=> '2',
					"file_name"				    => $destination_url.'dummy/bicycle.jpg',
					"our_price"	        		=> '15',
					"current_price"	 			=> '30',
					"coupon_entry"				=> 'coupon_entry_1',
					"coupon_code"				=> 'greatdiscount,getdiscount,friends,coupons',
...
$post_meta = array(
					...
					"min_purchases"	        	=> '1',
					"max_purchases_user"		=> '2',
					"file_name"				=> $destination_url.'dummy/vineyard.jpg',
					"our_price"	        		=> '45',
					"current_price"	 			=> '99',
					"coupon_entry"				=> 'coupon_entry_1',
					"coupon_code"				=> 'greatdiscount,getdiscount,friends,coupons',
...
$post_meta = array(
					...
					"_edit_lock"	        	=> '1310982937:1',
					"coupon_website"	        => 'http://ddb_wp.com',
					"file_name" 	   		 	=> 'dummy/dance.jpg',
					"tl_dummy_content"			=> '1',
					"min_purchases"	        	=> '1',
					"max_purchases_user"		=> '2',
					"file_name"				=> $destination_url.'dummy/dance.jpg',
					"our_price"	        		=> '200',
					"current_price"	 			=> '400',
					"coupon_entry"				=> 'coupon_entry_1',
					"coupon_code"				=> 'greatdiscount,getdiscount,friends,coupons',
...
$post_meta = array(
					...
					"tl_dummy_content"			=> '1',
					"min_purchases"	        	=> '1',
					"file_name"				=> $destination_url.'dummy/fun.jpg',
					"max_purchases_user"		=> '2',
					"our_price"	        		=> '15',
					"current_price"	 			=> '50',
					"coupon_entry"				=> 'coupon_entry_1',
...
//====================================================================================//
/////////////////////////////////////////////////
$pages_array = array(array('Page Templates','Advanced Search','Archives','Full Width','Left Sidebar Page','Shortcodes','Sitemap','Contact Us'),array('About Us','Shipping &amp; Handling'));
$page_info_arr = array();
		...
		if($page_info_arr)
		{
			for($j=0;$j<count($page_info_arr);$j++)
			{
				...
				}else
				{
					...
					$wpdb->query($guid_sql);
					$ter_relation_sql = "insert into $wpdb->term_relationships (object_id,term_taxonomy_id) values (\"$last_post_id\",\"$last_DDB_id\")";
...
full_copy( DDB_PUGIN_PATH."/images/dummy/", $folderpath );
function full_copy( $source, $target ) 
{
	$imagepatharr = explode('/',str_replace(DDB_PUGIN_PATH,'',$target));
...
$widget_socialbookmark[1] = array(
					...
					"facebook"			=>	'http://www.facebook.com/ddb_wp',
					"twitter_title"		=>	'DailyDeal on Twitter',
					"twitter"			=>	'http://twitter.com/ddb_wp',
					"rss_title"			=>	'DailyDeal Rss Feed',
					"rss"				=>	'http://feeds.feedburner.com/ddb_wp',					
					);						
...
update_option("ddbwpthemes_alt_stylesheet",'1-default');
update_option("ddbwpthemes_show_blog_title",'No');
update_option("ddbwpthemes_icoupon_aff",'?aff_id=2162');
update_option("ddbwpthemes_show_icoupon_deals",'Yes');
update_option("ddbwpthemes_tweet_button",'Yes');
update_option("ddbwpthemes_facebook_button",'Yes');
update_option("ddbwpthemes_date_format",'yyyy-mm-dd');
update_option("pttheme_contact_email",'info@mysite.com');
update_option("ddbwpthemes_breadcrumbs",'Yes');
update_option("ddbwpthemes_auto_install",'No');
update_option("ddbwpthemes_postcontent_full",'Excerpt');
update_option("ddbwpthemes_content_excerpt_count",'40');
update_option("ddbwpthemes_content_excerpt_readmore",'Read More &rarr;');
update_option("pttthemes_captcha",'Disable');
update_option("ptttheme_google_map_opt",'Disable');
update_option("ddbwpthemes_dealcomments",'Yes');
update_option("ddbwpthemes_timthumb",'Yes');
...
// Navigation settings
update_option("ddbwpthemes_main_pages_nav_enable",'Activate');
update_option("pttthemes_submit_deal_link",'Enable');
// Navigation settings

// Seo option
update_option("pttheme_seo_hide_fields",'No');
update_option("ddbwpthemes_use_third_party_data",'No');
// Seo option 

// Post  option
update_option("ddbwpthemes_home_page",'6');
update_option("ddbwpthemes_cat_page",'6');
update_option("ddbwpthemes_search_page",'6');
update_option("ddbwpthemes_pagination",'Default + WP Page-Navi support');
// Post  option 
...
update_option("ddbwpthemes_top_pages_nav",$pages_ids);
//Navigation  

// Page Layout
update_option("ddbwpthemes_page_layout",'Page 2 column - Right Sidebar');
update_option("ddbwpthemes_bottom_options",'Three Column');
// Page Layout
